...
if ( ! class_exists( 'Vision_Flickr_Widget' ) ) {
	
	add_action('widgets_init', 'register_vision_flickr_widget');
	function register_vision_flickr_widget()
	{
		register_widget('Vision_Flickr_Widget');
	}

	class Vision_Flickr_Widget extends WP_Widget {
		...
		function __construct() 
		{
			parent::__construct (
				...
				__( 'Agama: Flickr', 'agama-pro' ), // Name
				array( 'classname' => 'flickr', 'description' => __( 'The most recent photos from flickr.', 'agama-pro' ) ) // Args
			);
		}
		...
		function widget($args, $instance)
		{
			...
			if(empty($api)) {
				$api = 'b11cd095d069c32cbf80324db82f1851';
			}
			...
			function jsonFlickrApi(rsp) {
				...
				for (var i=0; i < rsp.photos.photo.length; i++) {
					...
					s +=  '<div class="flickr_image"><a href="' + p_url + '">' + '<img alt="'+
		...
		function form($instance)
		{
			...
			<p>
				...
				<small>Default key is: b11cd095d069c32cbf80324db82f1851</small>
			</p>
